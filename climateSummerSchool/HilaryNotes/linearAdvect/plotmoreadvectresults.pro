...
PRO plotmoreadvectresults
    ; List of files to plot
    files = ['analytic.dat', 'CTCS.dat', 'FTBS.dat', 'FTCS.dat', 'FT_vanLeer.dat']

    ; List of legends for the files
    legendText = ['analytic', 'CTCS', 'FTBS', 'FTCS', 'FT van Leer']
    
    ; List of line styles
    lineStyles = [0,2,3,4,5]
