% To illustrate 1D staggered grid and SW dispersion relation
...
text(0.285,0.2,'u','FontSize',16)
text(0.685,0.2,'u','FontSize',16)
text(0.08,0.22,'\Phi','FontSize',16)
text(0.48,0.22,'\Phi','FontSize',16)
text(0.88,0.22,'\Phi','FontSize',16)


text(0.07,-0.25,'j-1','FontSize',16)
text(0.495,-0.25,'j','FontSize',16)
text(0.87,-0.25,'j+1','FontSize',16)
text(0.25,-0.25,'j-1/2','FontSize',16)
text(0.65,-0.25,'j+1/2','FontSize',16)
hold off
